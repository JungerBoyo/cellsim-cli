...
CSIM::CellMap::CellMap(std::shared_ptr<const Shader> render_shader,
	...
	glBindBufferBase(GL_SHADER_STORAGE_BUFFER, shconfig::INSTANCE_OFFSETS_SSBO_BINDING_LOCATION, instance_offsets_ssbo_id_);
	...
	glBindBufferBase(GL_SHADER_STORAGE_BUFFER, shconfig::STATE_MAP_SSBO_BINDING_LOCATION, state_map_ssbo_id_);
